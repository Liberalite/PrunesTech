        ...
        <>
            <div className="tpoffcanvas-area">
                <div className={`tpoffcanvas ${sidebarOpen && "opened"}`}>
                    ...
                    <Link href="https://www.google.com/maps/place/Bd.+Tomis,+Constan%C8%9Ba/data=!4m2!3m1!1s0x40bae52fc1462c2d:0xdef182dc9c2f6c7?sa=X&ved=2ahUKEwiIhOOb_e2CAxXyygIHHdxTA1UQ8gF6BAgPEAA" target="_blank">
                        Bld Tomis Constanta Romania
                    </Link>
                    </div>
