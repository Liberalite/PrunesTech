...
const security_data = [
    ...
    // },
    {
        id: 4,
        img: security_img_4,
        title: <>AI Data <br /> Mining</>,        
    },
    {
        id: 5,
        img: security_img_1,
        title: <>Media & <br /> Analytics</>,        
    },
    // {
    //     id: 6,
    //     img: security_img_6,
...
const SecurityArea = () => {
    return (
        <>
            <div className="tp-security-area blue-bg pt-120 pb-180 fix z-index">
                  ...
                  <div className="row justify-content-center">
                     <div className="col-xl-8">
                        <div className="tp-security-section-box text-center pb-100">
                           ...
                           <h3 className="tp-section-title-4">Industries we know</h3>
                        </div>
                     </div>
                  </div>
