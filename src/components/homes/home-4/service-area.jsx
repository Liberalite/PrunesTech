...
const service_content = {
    ...
    title: "Services",
    description: <>Prunes Tech provides all customer marketing management <br /> services within one software.</>,
}
...
const ServiceArea = () => {
    return (
        <>
           <div id="services" className="tp-service-area blue-bg p-relative pt-115 pb-105">
