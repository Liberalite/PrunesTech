...
// import hero_4_img_1  from "../../../../public/assets/img/hero/hero-ai-agency.png";
// import hero_4_img_1  from "../../../../public/assets/img/hero/hero-marketing-agency.png";
import hero_4_img_1  from "../../../../public/assets/img/hero/hero-marketing.png";
import hero_4_img_2  from "../../../../public/assets/img/hero/hero-4-2.png";

const hero_content = {
    sub_title: "Welcome to Prunes Tech",
    title: <>
    <span><span className='child'>AI-Driven</span></span>{" "}
    <span><span className='child'>Marketing Agency</span></span>{" "}
    </>,
   //  title: "A1-Driven Marketing Agency Solutions",
}
