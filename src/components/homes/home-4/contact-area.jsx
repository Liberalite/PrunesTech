...
const contact_content = {
    ...
    phone: "+40 724 968 373",
    email: "contact@info.com",
    location: <>Bld Tomis Romania</>,
}
                     ...
                     <div className="col-xl-5 col-12 z-index-3 wow tpfadeLeft" data-wow-duration=".9s" data-wow-delay=".3s">
                        ...
                        <div className="tp-contact-info-box tp-title-anim">
                           <ul>
                              ...
                              <li>
                                <LocationTwo /> 
                                 <Link href="https://www.google.com/maps/place/Bd.+Tomis,+Constan%C8%9Ba/data=!4m2!3m1!1s0x40bae52fc1462c2d:0xdef182dc9c2f6c7?sa=X&ved=2ahUKEwiIhOOb_e2CAxXyygIHHdxTA1UQ8gF6BAgPEAA"
                              ...
                              <div className="col-xl-12">
                                 <div className="tp-contact-select">
                                    <div className="tp-select-icon"> 
                                       <NiceSelect
                                        options={[ 
                                            { value: "Marketing Services", text: "Marketing Services" },
                                            { value: "Branding Support", text: "Branding Support" },
                                            { value: "Web Development", text: "Web Development" },
                                            { value: "AI Analytics", text: "AI Analytics" }, 
                                        ]}
                                        defaultCurrent={0}
