...
const slider_data  = [
    {
        ...
        name: "Lana Rey",
        job: "Founder & Leader",
        info: <>&quot;Is it possible to Love your credit card processor? with Prunes Tech, yes!&quot;</>,
...
const TestimonialArea = () => {
    ...
    return (
        <>
            <div className="tp-testimonial-2-area pb-60" 
            style={{backgroundImage: `url(${bg_img})`, background: "#1117A0"}}
            >
                           ...
                           ref={sliderRef} 
                            ...
                            {slider_data.map((item, i)  => 
                                 <div key={i} className="tp-testimonial-2-item p-relative wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".3s">
                                    <div className="tp-testimonial-2-border-shape" style={{background: "#3137D2"}}>
